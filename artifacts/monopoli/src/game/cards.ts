...
export const CHANCE_CARDS: CardDeck[] = [
  ...
  { id: 2, type: "chance", text: "Maju ke Medan", action: { type: "move", to: 24 } },
  { id: 3, type: "chance", text: "Maju ke Palembang", action: { type: "move", to: 11 } },
  { id: 4, type: "chance", text: "Maju ke Bandara terdekat", action: { type: "move-to-nearest-railroad" } },
  ...
  { id: 12, type: "chance", text: "Maju ke Bandara Soekarno-Hatta", action: { type: "move", to: 5 } },
  { id: 13, type: "chance", text: "Maju ke Bali", action: { type: "move", to: 39 } },
...
export const COMMUNITY_CARDS: CardDeck[] = [
  ...
  { id: 12, type: "community-chest", text: "Pajak jalan: M40 per rumah, M115 per hotel", action: { type: "repairs", house: 40, hotel: 115 } },
  ...
  { id: 16, type: "community-chest", text: "Dana liburan! Terima M100", action: { type: "money", amount: 100 } },
];
